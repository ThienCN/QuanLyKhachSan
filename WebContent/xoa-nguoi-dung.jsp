            ...
            <nav class="navbar navbar-default">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand"><i class="glyphicon glyphicon-trash"></i></a>
                    </div>
                    <div class="nav navbar-nav navbar-left">
                        <a id="page-trich-dan" href="cap-nhat-nguoi-dung.jsp">XÓA NGƯỜI DÙNG</a>
                    </div>
        ...
        <nav class="navbar-default nav-menu">
            <div id="nav-left" class="navbar-collapse collapse">
                <ul class="nav">
                    ...
                    <li class="active"><a href="xoa-nguoi-dung.jsp"><i class="glyphicon glyphicon-trash"></i> Xóa người dùng</a></li>
